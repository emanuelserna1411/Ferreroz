        ...
        <div class="row">
            <div class="col-sm-12 col-md-8">
                ...
                <form action="updateVenta.php" method="post">
                    <div class="codigo">
                        <label for="disabledTextInput" class="form-label">codigo de venta</label>
                        <input type="text" name="codVenta" class="form-control" id="nombre" value="<?php echo($codV)?>" readonly>
                    </div>
                    <div class="codigo">
                    ...
                    <div class="Precio">
                        ...
                        <input type="text" name="total" class="form-control" id="nombre" value="<?php echo($total)?>">
                    </div>
                    <div class="d-grid gap-2 mt-2">
                        <button class="btn btn-primary" type="submit">Editar</button>
                    </div>
                    <div class="d-grid gap-2 mt-2">
                        <a href="ventas.php" class="btn btn-secondary">Cancelar</a></button>
                    </div>
                </form>
            </div>
        </div>
